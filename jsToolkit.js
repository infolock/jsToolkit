...
(function() {
  ...
  jsToolkit.consoleLog: function (msg, obj) {
  ...
  jsToolkit.applyCallback: function(obj, callback) {
    obj = obj || this;
  ...
  jsToolkit.getJSONData: function(options, responseCallback){
  ...
  jsToolkit.getURLParts: function(urlString) {
